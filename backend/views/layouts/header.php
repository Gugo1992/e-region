                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <?php } else { ?>
                                <img src="<?php echo \Yii::$app->request->BaseUrl ?>/avatar.jpg" class="img-thumbnail img-profile" style="width: 19px">
                            <?php } ?>
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <?php if (!empty($row['image_profile'])) { ?>
                                <img src="<?php echo \Yii::$app->request->BaseUrl . '/' . $row['image_profile'] ?>" class="user-image" alt="User Image" style=""/>
                            <?php } else { ?>
                                <img src="<?php echo \Yii::$app->request->BaseUrl ?>/avatar.png" class="img-thumbnail img-profile" style="width: 19px">
                            <?php } ?>
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-header">
                                <?php if (!empty($row['image_profile'])) { ?>
                                    <img src="<?php echo \Yii::$app->request->BaseUrl . '/' . $row['image_profile'] ?>" class="img-circle" alt="User Image" style=""/>
                                <?php } else { ?>
                                    <img src="<?php echo \Yii::$app->request->BaseUrl ?>/avatar.png" class="img-thumbnail img-profile">
                                <?php } ?>
